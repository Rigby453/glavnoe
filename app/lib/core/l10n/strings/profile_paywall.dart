...
const Map<String, Map<String, String>> profilePaywallStrings = {
  ...
  'profile.feedback_email': {
    'en': 'Email us: support.kaname@gmail.com',
    'ru': 'Напиши нам: support.kaname@gmail.com',
    'de': 'Schreib uns: support.kaname@gmail.com',
    'fr': 'Écris-nous : support.kaname@gmail.com',
    'it': 'Scrivici: support.kaname@gmail.com',
    'pt': 'Escreva para: support.kaname@gmail.com',
    'es': 'Escríbenos: support.kaname@gmail.com',
    'id': 'Email kami: support.kaname@gmail.com',
    'hi': 'हमें ईमेल करो: support.kaname@gmail.com',
    'ja': 'メールはこちら: support.kaname@gmail.com',
    'ko': '이메일: support.kaname@gmail.com',
  },
  // Fallback SnackBar когда почтовый клиент недоступен (#25)
  'profile.support_copied': {
    ...
    'id': 'Alamat email disalin ke clipboard',
    'hi': 'ईमेल पता क्लिपबोर्ड पर कॉपी हुआ',
    'ja': 'メールアドレスをクリップボードにコピーしました',
    'ko': '이메일 주소가 클립보드에 복사됐어요',
  },
  ...
  'profile.advanced_water': {
    'en': 'Water tracking',
    'ru': 'Учёт воды',
    'de': 'Wasser-Tracking',
    'fr': "Suivi de l'hydratation",
  ...
  'profile.advanced_water_subtitle': {
    'en': 'Log water intake and see your daily hydration goal',
    'ru': 'Отмечай выпитую воду и следи за дневной нормой',
    'de': 'Erfasse deine Wasseraufnahme und dein tägliches Ziel',
    'fr': "Enregistre ta consommation d'eau et ton objectif quotidien",
    'it': "Registra l'acqua bevuta e il tuo obiettivo giornaliero",
    'pt': 'Registre a água consumida e acompanhe sua meta diária',
    'es': 'Registra el agua que tomas y sigue tu meta diaria',
    'id': 'Catat konsumsi air dan lihat target harianmu',
    'hi': 'पानी का सेवन दर्ज करें और अपना दैनिक लक्ष्य देखें',
    'ja': '水分摂取を記録し、1日の目標を確認',
    'ko': '수분 섭취를 기록하고 하루 목표를 확인하세요',
  },
  ...
  // ---- Profile: редактирование имени и аватара ----
  /// Tooltip кнопки-карандаша рядом с именем в подстранице «Аккаунт».
  'profile.edit_name': {
    'en': 'Edit name',
    'ru': 'Изменить имя',
    'de': 'Namen bearbeiten',
  ...
  /// Подпись текстового поля в диалоге переименования.
  'profile.edit_name_label': {
    'en': 'Display name',
    'ru': 'Отображаемое имя',
    'de': 'Anzeigename',
    'fr': 'Nom affiché',
  ...
  /// Подсказка под полем: имя хранится только на этом устройстве (нет синка).
  'profile.edit_name_hint': {
    'en': 'Saved on this device only',
    'ru': 'Сохраняется только на этом устройстве',
    'de': 'Wird nur auf diesem Gerät gespeichert',
    'fr': 'Enregistré uniquement sur cet appareil',
    'it': 'Salvato solo su questo dispositivo',
    'pt': 'Salvo apenas neste dispositivo',
    'es': 'Guardado solo en este dispositivo',
    'id': 'Hanya disimpan di perangkat ini',
    'hi': 'केवल इसी डिवाइस पर सेव होता है',
    'ja': 'この端末にのみ保存されます',
    'ko': '이 기기에만 저장됩니다',
  },
  /// Снэкбар после сохранения нового имени.
  ...
  /// Tooltip аватара-кружка (открывает выбор пресета).
  'profile.edit_avatar': {
    'en': 'Change avatar',
    'ru': 'Сменить аватар',
    'de': 'Avatar ändern',
  ...
  /// Заголовок шита выбора аватара.
  'profile.choose_avatar_title': {
    'en': 'Choose an avatar',
    'ru': 'Выбери аватар',
    'de': 'Avatar wählen',
