...
const Map<String, Map<String, String>> workoutsLibraryStrings = {
  ...
  'exercise.push_up.mistake2': {
    'en': 'Flaring elbows wide — keep them at ~45° to keep your shoulders safe.',
    'ru': 'Локти уходят в стороны — держите угол ~45° для здоровья плечевых суставов.',
    'hi': 'कोहनियाँ बहुत चौड़ी फैलती हैं — कंधों की सुरक्षा के लिए ~45° पर रखें।',
    'ja': '肘が大きく開く — 肩の安全のために~45°を保つ。',
    'ko': '팔꿈치가 너무 넓게 벌어짐 — 어깨 건강을 위해 ~45°로 유지한다.',
    'de': 'Ellenbogen zu weit abspreizen — ca. 45° halten, um die Schultern zu entlasten.',
    'fr': 'Coudes trop écartés — gardez-les à environ 45° pour préserver les épaules.',
    'it': 'Gomiti troppo aperti — mantienili a circa 45° per la salute delle spalle.',
    'pt': 'Cotovelos muito abertos — mantenha-os a ~45° para preservar os ombros.',
    'es': 'Codos muy abiertos — mantenlos a ~45° para cuidar los hombros.',
    'id': 'Siku terlalu melebar — jaga sudut ~45° untuk menjaga kesehatan bahu.',
  },
  ...
  'exercise.incline_dumbbell_press.mistake1': {
    'en': 'Dumbbells flaring out too wide — keep elbows at ~45° to keep the shoulder joint healthy.',
    'ru': 'Гантели уходят слишком широко — держите локти под углом ~45° для здоровья плечевого сустава.',
    'hi': 'डम्बल बहुत चौड़े फैलते हैं — कंधे के जोड़ की सुरक्षा के लिए कोहनियां ~45° पर रखें।',
    'ja': 'ダンベルが大きく開きすぎる — 肩関節の健康のため肘を~45°に保つ。',
    'ko': '덤벨이 너무 넓게 벌어짐 — 어깨 관절 건강을 위해 팔꿈치를 ~45°로 유지한다.',
    'pt': 'Halteres abrindo muito — mantenha os cotovelos a ~45° para preservar a articulação do ombro.',
    'es': 'Mancuernas abriéndose demasiado — mantén los codos a ~45° para cuidar la articulación del hombro.',
    'id': 'Dumbbell terlalu melebar — jaga siku pada ~45° untuk menjaga kesehatan sendi bahu.',
    'de': 'Hanteln zu weit abspreizen — Ellenbogen bei ~45° halten, um das Schultergelenk zu entlasten.',
    'fr': 'Haltères trop écartés — gardez les coudes à ~45° pour préserver l\'articulation de l\'épaule.',
    'it': 'Manubri troppo aperti — mantieni i gomiti a ~45° per la salute dell\'articolazione della spalla.',
  },
