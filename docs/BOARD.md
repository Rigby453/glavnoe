...
## Текущая фаза: Ф1 (платный контур) — старт 2026-06-10
Порядок: Water (график + анимация 4.2) → Баланс рациона → сканер штрихкода →
ИИ-фото еды (AI-03) → Wrapped Неделя/Месяц (+AI-05) → список покупок →
анимации Ф1 (§5 «День завершён» полноэкранный, §7 skeleton/pulse) → RevenueCat.
Примечание: тема Calm и конфетти уже сделаны в MVP. Телефонную проверку
